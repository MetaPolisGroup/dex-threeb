import authorParra from "../assets/images/nfts/img/authors/1.jpg";
import collection1Para from "../assets/images/nfts/img/nfts-img/1.jpg";
import collection2Para from "../assets/images/nfts/img/nfts-img/2.jpg";
import collection3Para from "../assets/images/nfts/img/nfts-img/3.jpg";
import authorCyber from "../assets/images/nfts/img/authors/3.jpg";
import collection7Cyber from "../assets/images/nfts/img/nfts-img/7.jpg";
import collection8Cyber from "../assets/images/nfts/img/nfts-img/8.jpg";
import collection9Cyber from "../assets/images/nfts/img/nfts-img/9.jpg";
...
export const networkCollections = {
  "0x38": [
    ...
    },
    {
      ...
      addrs: "",
      imageCollections: {
        img_0: collection1Para,
        img_1: collection2Para,
        img_2: collection3Para,
      },
      added: true,
      createdBy: "HOLDER",
      description: "",
    ...
    },
    {
      ...
      addrs: "",
      imageCollections: {
        img_0: collection7Cyber,
        img_1: collection8Cyber,
        img_2: collection9Cyber,
      },
      added: true,
      createdBy: "Yobaninja",
      description: "",
